...
#         print('Ты маленький')
# except:
#     print('Введите только числа пожалуйста')
# else:
#     print('Без ошибок')
...
#     print("at > 5)
# except(SyntaxError):
#     print('Брат ты ошибся с написании кода')
# except(IndentationError):
#     print('Брат ты подвинул неправильно')
# except(TypeError):
#     print('Брат ты короче ошибка')
# except:
#     print('Бра ты просто ошибся, я не знаю где')
